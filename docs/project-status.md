...
Phase 5 仅使用 Phase 1 的 RLS/RPC、Phase 3 的脱敏库存 fixture 和本地或预览 Supabase，已按 ADR 0005 独立完成实现与自动化验收。Phase 6 已完成配种器、异步 Worker、最多三条确定性路线比较、AI 降级解释和本地真实目录/快照集成；生产部署仍未授权。
