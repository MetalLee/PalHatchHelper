create function public.get_breeder_form_context(p_locale text default 'zh-CN')
returns jsonb
language plpgsql
stable
security definer
...
comment on function public.get_breeder_form_context(text) is
  'Authenticated, bound-player, browser-safe Phase 6 form context with no inventory rows or internal player UUIDs.';
